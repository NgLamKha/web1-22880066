...
templates['gallery-categories-template'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "<li class=\"nav-item\">\r\n  <a\r\n    class=\"nav-link disabled ps-0\"\r\n    href=\"#\"\r\n    aria-current=\"page\"\r\n    onclick=\"loadData('gallery', 'gallery-template', 'gallery'); disableLink(this)\"\r\n  >\r\n    Show all\r\n  </a>\r\n</li>\r\n"
    + ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"data") : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":11,"column":0},"end":{"line":19,"column":9}}})) != null ? stack1 : "");
},"useData":true});
